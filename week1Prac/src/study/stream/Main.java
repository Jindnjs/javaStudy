...
//        List<Integer> list1 = list.study.stream().map(x -> x * 2).collect(Collectors.toList());
//        System.out.println("list1 = " + list1);
//        List<Integer> list2 = list.study.stream().map(x -> x*2).toList();
...
//            }
//        };
//        list.study.stream().filter()
//        List<Integer> res1 = list.study.stream().map(func).toList();
//        System.out.println("res1 = " + res1);
//
//        //람다식 만들기
//        Function<Integer,Integer> func2 = (a -> a * 2);
//        List<Integer> res2 = list.study.stream().map(func2).toList();
//
//        System.out.println("res2 = " + res2);
//
//        //직접 람다식 대입
//
//        System.out.println("res3 = " + list.study.stream().map(x -> x*2).toList());\\
